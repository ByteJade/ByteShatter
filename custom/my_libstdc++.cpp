...
extern "C" {
    ...
    WRAP_FUNC(_ZNSt12__shared_ptrINSt10filesystem7__cxx114_DirELN9__gnu_cxx12_Lock_policyE2EEC1EOS5_)
    ...
    WRAP_FUNC(_ZNKSt10filesystem7__cxx114path7compareERKS1_)
    WRAP_FUNC(_ZNSt10filesystem7__cxx114path14_M_split_cmptsEv)
    WRAP_FUNC(_ZNKSt10filesystem7__cxx114path17_M_find_extensionEv)
    WRAP_FUNC(_ZNSt10filesystem7__cxx1118directory_iteratorppEv)
    WRAP_FUNC(_ZNSt10filesystem7__cxx114path5_ListC1Ev)
    ...
    WRAP_FUNC(_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE)
    WRAP_FUNC(_ZNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEE3strERKNS_12basic_stringIcS2_S3_EE)
    WRAP_FUNC(_ZNKSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEE3strEv)
    WRAP_FUNC(_ZNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEED1Ev)
    WRAP_FUNC(_ZNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEC1Ev)
    WRAP_FUNC_VOID(_ZNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEED1Ev)
    WRAP_FUNC(_ZNKSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEE3strEv)
